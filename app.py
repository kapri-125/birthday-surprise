...
p{font-size:20px}
button{
    padding:15px 35px;font-size:18px;background:#ff4f9a;
...
#cakePhoto{
    display:none;width:220px;margin:20px auto;
    border-radius:25px;
}
...
.balloon{
    position:fixed;bottom:-60px;font-size:40px;
    z-index:9999;animation:float 7s linear forwards;
}
@keyframes float{
...
function moveNo(){
    ...
    noBtn.style.left=Math.random()*180-90+"px";
